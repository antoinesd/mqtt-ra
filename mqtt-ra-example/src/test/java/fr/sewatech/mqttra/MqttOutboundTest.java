...
public class MqttOutboundTest {

    @Deployment
    public static EnterpriseArchive createDeployment() {

        JavaArchive raImplLib = ShrinkWrap.create(JavaArchive.class, "connector-impl.jar")
                .addPackages(true, MqttManagedConnectionFactory.class.getPackage());
        JavaArchive raApiLib = ShrinkWrap.create(JavaArchive.class, "connector-api.jar")
                .addPackages(true, MqttMessageListener.class.getPackage())
                .addAsResource("fr.sewatech.mqttra.connector.mqttra/service-jar.xml", "fr.sewatech.mqttra.connector.mqttra/service-jar.xml");
        ...
        JavaArchive ejbJar = ShrinkWrap.create(JavaArchive.class, "ejb.jar")
                .addAsManifestResource(EmptyAsset.INSTANCE, "beans.xml")
                .addClasses(FirstMqttBean.class);

        WebArchive war = ShrinkWrap.create(WebArchive.class, "test.war")
                .addClasses(MqttOutboundTest.class);
